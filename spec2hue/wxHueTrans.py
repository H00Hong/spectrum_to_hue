...
class HueTrans(wx.Panel):
    ...
    def _init_ui(self):
        self.box_out = wx.StaticBox(self, label='输出')
        self.box_in = wx.StaticBox(self, label='输入')
        # 输入
        self.lab_l00 = wx.StaticText(self, label='光源')
        self.lab_l01 = wx.StaticText(self, label='视场角')
        ...
        self.btn_l6 = wx.Button(self, label='转  换')
    ...
    def _layout0(self):
        ...
        self.layout0.Add(_line_v(self), 0, wx.ALL | wx.EXPAND, 10)
